...
#[derive(Message, Clone)] // Clone is derived to allow easy duplication of the message for broadcasting
#[rtype(result = "()")]
...
impl Actor for WebSocket {
    ...
    type Context = ws::WebsocketContext<Self>;  // defines the type of context used by the WS actor
